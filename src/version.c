 ...
 *  USA
 *
 *  $Id: version.c 501 2007-07-11 06:41:15Z jon $
 */
...
const char *infotext[] = {
	...
	"of people, all of us.",
	"",
	"The goal of the plexus patchset is to give hybrid tighter services",
	"integration and other features. While mainly written for use on Rizon,",
	"many of its features would be of benefit to any network.",
	"",
