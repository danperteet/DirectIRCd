 ...
 *  USA
 *
 *  $Id: ircd_parser.y 505 2007-07-16 16:47:50Z jon $
 */
...
%token  ANTI_SPAM_CONNECT_NUMERIC
%token  AUTOCONN
%token  T_BLOCK
%token  BURST_AWAY
...
general_item:       general_hide_spoof_ips | general_ignore_bogus_ts |
		    ...
		    general_max_accept | general_anti_spam_exit_message_time |
                    general_anti_spam_connect_numeric |
...
channel_item:       channel_disable_local_channels | channel_use_except |
                    ...
                    channel_cycle_on_hostchange |  error;
