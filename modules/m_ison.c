 ...
 *  USA
 *
 *  $Id: m_ison.c 147 2005-12-26 02:52:10Z jon $
 */
 ...
 */
static void
ms_ison(struct Client *client_p, struct Client *source_p, int parc, char *parv[])
{
...
static void
do_ison(struct Client *client_p, struct Client *up, struct Client *source_p, int parc, char *parv[])
{
