...
static void me_chgident(struct Client *, struct Client *, int, char *[]);
static void mo_chgident(struct Client *, struct Client *, int, char *[]);

struct Message chgident_msgtab = {
	"CHGIDENT", 0, 0, 2, 0, MFLG_SLOW, 0,
	{m_unregistered, m_ignore, m_ignore, me_chgident, mo_chgident, m_ignore}
};
...
mo_chgident(struct Client *client_p, struct Client *source_p, int parc, char *parv[])
{
	...
	if(!*parv[2] || !valid_username(parv[2]))
	{
		sendto_one(source_p, form_str(ERR_CANNOTDOCOMMAND),
