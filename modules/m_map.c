 ...
 *  USA
 *
 *  $Id: m_map.c 147 2005-12-26 02:52:10Z jon $
 */
 ...
 */
static void
dump_map(struct Client *client_p, struct Client *root_p, int start_len, char *pbuf)
{
	...
	*pb++ = '|';
	...
	sprintf(pb, " Users: %5d (%1.1f%%)", users, 100 * (float) users / (float) Count.total);
