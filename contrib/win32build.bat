...
for %%a in (modules\m_challenge.c modules\m_cryptlink.c contrib\example_module.c contrib\ip_cloaking.c) do if exist %%a del %%a
...
pause
:end2
rem $Id: win32build.bat 129 2005-12-10 00:07:02Z jon $
