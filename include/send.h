 ...
 *  USA
 *
 *  $Id: send.h 493 2007-07-07 17:45:14Z jon $
 */
...
AFP(2, 3);
     extern void sendto_channel_butone(struct Client *, struct Client *,
				       struct Channel *, const char *, const char *, ...) AFP(5, 6);
     extern void sendto_common_channels_local(struct Client *, int, const char *, ...) AFP(3, 4);
     extern void sendto_channel_local(int, int, struct Channel *, const char *, ...) AFP(4, 5);
     extern void sendto_channel_local_butone(struct Client *, int, int, struct Channel *,
					     const char *, ...) AFP(5, 6);
     extern void sendto_channel_remote(struct Client *, struct Client *, int,
				       int, int, struct Channel *, const char *, ...) AFP(7, 8);
     extern void sendto_server(struct Client *, struct Client *,
			       struct Channel *, unsigned long,
			       unsigned long, unsigned long, const char *, ...) AFP(7, 8);
     ...
     extern void sendto_wallops_flags(unsigned int, struct Client *, const char *, ...) AFP(3, 4);
