 ...
 * \version $Id: channel.h 493 2007-07-07 17:45:14Z jon $
 */
...
extern int can_send(struct Channel *, struct Client *, struct Membership *, char *, int);
...
extern void do_hostchange_quits(struct Client *);
extern void do_hostchange_joins(struct Client *);

extern const char *get_member_status(const struct Membership *, int, int);
